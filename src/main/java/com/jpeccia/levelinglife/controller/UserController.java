...
public class UserController {
    ...
    @PostMapping("/update")
    public ResponseEntity<String> updateProfile(@RequestBody @Valid @Parameter(description = "Dados para atualização do perfil do usuário.") UserProfileUpdateDTO body) {
        // Obter o usuário autenticado do contexto de segurança
        User user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
